...
const GroupSettingsDB = createModel("GroupSettingsDB", {
        id: {
...
const AntilinkWarningsDB = createModel("AntilinkWarningsDB", {
        id: {
            type: DataTypes.INTEGER,
            primaryKey: true,
            autoIncrement: true,
...
const AntibadWarningsDB = createModel("AntibadWarningsDB", {
        id: {
            type: DataTypes.INTEGER,
            primaryKey: true,
            autoIncrement: true,
...
const BadWordsDB = createModel("BadWordsDB", {
        id: {
            type: DataTypes.INTEGER,
            primaryKey: true,
            autoIncrement: true,
...
const AntiGroupMentionWarningsDB = createModel("AntiGroupMentionWarningsDB", {
        id: {
            type: DataTypes.INTEGER,
            primaryKey: true,
            autoIncrement: true,
